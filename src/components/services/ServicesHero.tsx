...
export default function ServicesHero() {
  return (
    <section className="relative overflow-hidden bg-gray-900" style={{ backgroundColor: company.colors.dark }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center pt-32 pb-20 lg:pt-40 lg:pb-28 min-h-[500px] lg:min-h-[600px]">
          <div className="relative animate-fade-in-right">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
              From contract placements to executive search, we deliver tailored talent solutions that align with your business objectives.
            </p>
          </div>
        </div>
      </div>
