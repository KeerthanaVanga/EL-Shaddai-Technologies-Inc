        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl animate-fade-in-right">
            ...
            <h2
              ...
              style={{ color: company.colors.dark }}
            >
              Your Strategic Talent Partner
            </h2>
            <p className="text-gray-600 mb-8 leading-relaxed">
              {company.name} has built a reputation for delivering exceptional
              IT talent solutions with speed, precision, and care. We understand
              your business challenges and deliver results.
            </p>
          ...
          >
            <div className="flex flex-col gap-6">
              <img
                src="/el-sheddai_images/Your_Strategic_Talent_Partner.png"
                alt="Team meeting"
                className="w-full h-64 object-cover rounded-xl shadow-lg"
              />
              <img
                src="/el-sheddai_images/Your_Strategic_Talent_Partner1.png"
