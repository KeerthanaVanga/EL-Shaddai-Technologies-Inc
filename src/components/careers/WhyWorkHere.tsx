          ...
          <FadeIn direction="left">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed mb-12 text-lg">
                At {company.name}, we believe our people are our greatest asset.
                We invest in your growth, celebrate your wins, and create an
                environment where exceptional work thrives.
              </p>
