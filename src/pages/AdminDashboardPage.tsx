...
import { isAdminAuthenticated, adminLogout } from "../data/adminData";
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!sessionStorage.getItem("admin_welcomed")) {
      ...
      setTimeout(() => toast("success", "Welcome back, Admin!"), 150);
    }
  }, [navigate, toast]);
      ...
      <header className="bg-[#0B1426] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg overflow-hidden border border-white/10 flex-shrink-0">
              <img
                src="/elsaddai.jpeg"
                alt="Logo"
