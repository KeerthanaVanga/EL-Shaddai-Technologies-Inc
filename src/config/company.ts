...
export const company = {
  ...
  services: [
    ...
    },
    {
      ...
      badge: "Flexible",
      description:
        "Scale your team up or down with flexible contract professionals. Perfect for project-based work.",
      features: [
  ...
  about: {
    ...
    description:
      "Founded on faith, driven by excellence. We are a premier IT staffing firm dedicated to connecting America's businesses with world-class technology talent.",
    mission:
      "To empower businesses by providing innovative, efficient, and reliable IT talent solutions that drive growth, foster innovation, and create lasting value. We serve as the critical bridge between exceptional technology professionals and the organizations that need them.\n\nWe supply our talent network by building a deep understanding of both our clients' technical requirements and our candidates' career aspirations — ensuring a win-win for all parties.",
    vision:
      "To be the most trusted name in IT staffing across North America — recognized for our integrity, precision, and transformative impact on the careers and companies we serve.",
    values: [
      {
        icon: "excellence",
        title: "Excellence",
      ...
      },
      {
        ...
        title: "Partnership",
        description:
          "We view ourselves as an extension of your team — aligned with your goals, culture, and long-term success.",
      },
      {
        icon: "value",
        title: "Value",
        description:
          "We don't just fill roles; we help you build teams that drive ROI and move your business forward.",
      },
    ],
    founder: {
  ...
  whyUs: {
    ...
    description:
      "We go beyond resumes. We build careers, strengthen teams, and power IT organizations with talent that truly fits.",
    reasons: [
      {
        icon: "✅",
        title: "Pre-Vetted Candidates",
        description:
          "Every candidate goes through a rigorous screening process — technical assessments, background checks, and cultural fit evaluations.",
      },
      {
        icon: "⚡",
      ...
      },
      {
        ...
        description:
          "You get a single point of contact who understands your business, your culture, and your technical requirements.",
      },
      {
        icon: "🌎",
        title: "Nationwide Reach",
        description:
          "From coast to coast, our talent network spans all major tech hubs and remote markets.",
      },
      {
        icon: "🧠",
        title: "Deep Technical Expertise",
        description:
          "Our recruiters have hands-on experience in IT fields — they speak your language.",
      },
      {
        icon: "🏆",
    ...
    ctaAccent: "IT Star?",
    ctaDescription:
      "Let's talk about your hiring needs. Our team is standing by to help you build the IT workforce of tomorrow.",
  },
  ...
  careers: {
    ...
    description:
      "Join a team of passionate talent professionals making a real difference in people's careers and companies' success.",
    whyWorkHere: [
      {
        icon: "career-growth",
        title: "Career Growth",
    ...
    noPositionsMessage:
      "We don't have any active job listings at the moment. However, we're always looking for talent!",
  },
  ...
  products: {
    ...
    description:
      "Discover our curated suite of technology products and platform solutions designed to accelerate your business growth.",
    items: [],
    comingSoonMessage:
      "We're finalizing our product catalog. Check back soon for our exciting lineup of technology solutions.",
  },
  ...
  contact: {
    ...
    description:
      "Whether you need to fill a critical role, explore our services, or simply want to learn more — we're here to help.",
    officeHours: [
  ...
  footerDescription:
    "Building high-performance IT talent pipelines. Your trusted partner in technology staffing and workforce solutions.",
};
